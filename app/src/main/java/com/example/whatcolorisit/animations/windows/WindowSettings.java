...
public class WindowSettings extends Window {
    ...
    public static void setSettingsView(ScrollView settingsView) {
        WindowSettings.settingsView = settingsView;
    }
    ...
    public void showWindow() {
        ...
        animator.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationStart(Animator animation) {
                WindowSettings.getSettingsView().setVisibility(View.VISIBLE);
            }
    ...
    public void hideWindow() {
        ...
        animator.addListener(new Animator.AnimatorListener() {
            ...
            @Override
            public void onAnimationEnd(Animator animation) {
                WindowSettings.getSettingsView().setVisibility(View.GONE);
            }
